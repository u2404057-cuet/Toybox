  ...
  return (
    <div className="bg-white p-8 rounded-3xl shadow-md border border-border w-full max-w-md">
      <div className="text-center mb-8">
        ...
        <p className="text-muted text-sm mt-1">Please sign in to your account</p>
      </div>
      ...
      <div className="mt-6 text-center text-sm text-muted">
        ...
        <Link href={`/auth/register?redirect=${encodeURIComponent(redirectPath)}`} className="text-cobalt font-bold hover:underline">
          Register
        </Link>
      </div>
    </div>
